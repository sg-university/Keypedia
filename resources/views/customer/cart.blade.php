...
<body style="background-color: skyblue">
    ...
    <div class="container d-flex justify-content-center my-5 p-5" style="background-color : 	violet;">
        <div>
            <div class="row my-2 mx-2 main">
                ...
                <div class="col-md-8 col-12 xcol">
                    <h3>AKKO 3061 World Tour Tokyo</h3>
                    <p class="mt-4">Subtotal: $ 160</p>
                    <div class="col-md-8 col-12 xcol">
                        <form class="form-horizontal" action="/customer/index" method="get">

                            <div class="form-group row mb-3">
                                <label class="col-md-3 col-form-label" for="price">Quantity</label>
                                <div class="col-md-8">

...
<div class="container d-flex justify-content-center my-5 border p-5" style="background-color : 	violet;">
    <div class="row my-2 mx-2 main">
        ...
        <div class="col-md-8 col-12 xcol">
            <form class="form-horizontal" action="/manager/index" method="get">
                @csrf

                <div class="form-group row mb-3">
                    <label for="keyboardname" class="col-md-3 col-form-label">Categoryd Name</label>
                    <div class="col-md-8">
                ...
                <div class="form-group row mb-3">
                    <label class="col-md-3 col-form-label" for="file">Category images</label>
                    <div class="col-md-8">

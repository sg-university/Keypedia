                ...
                <form class="form-inline">
                    <div class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <li>
                                    <a class="dropdown-item" href="{{ route('customer.cart.index') }}">My cart</a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('customer.transaction.index') }}">Transaction History</a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('customer.change-password.index') }}">Change Password</a>
                                </li>
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('customer.header.api.logout') }}">Logout</a>
                                </li>
                            </ul>
                        </li>
